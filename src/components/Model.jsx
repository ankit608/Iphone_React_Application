...
const Model = () => {
  ...
  return (
    ...
    <section className='common-padding'>
        ...
        <ModelView index={1} GroupRef={small} gaspType={small} setRotationState={setSmallRotation} item={Model} size={size}></ModelView>
        <ModelView index={1} GroupRef={small} gaspType={small} setRotationState={setSmallRotation} item={Model} size={size}></ModelView>
                        ...
                        <button className='size-btn-container'>
                            {
                                sizes.map(({label,value})=>{
                                  return( <span key={label} className='size-btn' style={{backgroundColor:size===value?'white':'transparent', color: size===value?'black':'white'}} onClick={()=> setSize(value)}>
                                  {label}
                                 </span>)
                                })
                            }
